...
import ru.avem.kserialpooler.adapters.stringascii.StringASCIIAdapter
...
class GPT(
    ...
    private fun readRequest(request: String) = protocolAdapter.read(request)
    ...
    private fun getMeas(): Array<String> {
