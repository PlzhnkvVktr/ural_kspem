...
class PRModel : IDeviceModel {
    ...
    val VIBRO_POL = "VIBRO_POL"
    val VIBRO_RAB = "VIBRO_RAB"
    ...
    override val registers: Map<String, DeviceRegister> = mapOf(
        ...
        VIBRO_POL to DeviceRegister(543, DeviceRegister.RegisterValueType.FLOAT), // CDAB
        VIBRO_RAB to DeviceRegister(545, DeviceRegister.RegisterValueType.FLOAT), // CDAB
        PRESSURE to DeviceRegister(535, DeviceRegister.RegisterValueType.FLOAT), // CDAB
    )
